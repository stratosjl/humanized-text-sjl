...
| `να είμαι καθαρός` / `να είμαστε καθαροί` (δήλωση σαφήνειας) | Calque του «let me be clear» (Rule §16) | `για να είμαι σαφής` / `για να είμαστε σαφείς` |
| `είναι καθαρό ότι/πως` | Calque του «it's clear that» (Rule §16) | `είναι σαφές ότι` / `είναι ξεκάθαρο ότι` |
| «Ροή 2», «Κανόνας 3», «Φάση 1» (ουσιαστικό-ετικέτα σειράς με απόλυτο αριθμητικό μετά) | Απόλυτο αντί τακτικού σε αριθμημένη σειρά (Rule §18) | Τακτικό: «Ροή 2η» ή «δεύτερη ροή». Εξαίρεση: παραπομπές (άρθρο 27, παρ. 1, ΦΕΚ 235) |
...
|---|---|
| reconciliation (λογιστική / οικονομική) | συμφωνία (συμφωνία λογαριασμών, τραπεζική συμφωνία). ΟΧΙ «συμφιλίωση» (βλ. §16) |
| cross-check / cross-checking | διασταύρωση / διασταυρώνω. ΟΧΙ «σταυρώνω / σταύρωσε» (βλ. §16) |
...
| να είμαι καθαρός / να είμαστε καθαροί | για να είμαι σαφής / για να είμαστε σαφείς | Calque του αγγλικού «let me be clear». Στα ελληνικά το «καθαρός» για πρόσωπο δηλώνει καθαριότητα ή αθωότητα, όχι σαφήνεια λόγου. Εναλλακτικά: «για να το πω καθαρά» (το επίρρημα είναι δόκιμο, το κατηγορούμενο όχι). |
| είναι καθαρό ότι / είναι καθαρό πως | είναι σαφές ότι / είναι ξεκάθαρο ότι | Calque του αγγλικού «it's clear that». Το ίδιο ισχύει για την «καθαρότητα» με την έννοια της σαφήνειας λόγου: το σωστό ουσιαστικό είναι «σαφήνεια» («με όση σαφήνεια μπορώ», όχι «με όση καθαρότητα μπορώ»). Το «ξεκάθαρος» είναι δόκιμο· το σκέτο «καθαρός» με αυτή την έννοια όχι. |
| αγκύρωση / άγκυρα / αγκυρωμένος (μεταφορικά, για «anchored/anchor») | βάση / έρεισμα / θεμέλιο / σημείο αναφοράς / πατάει σε | Calque του «anchor/anchored». Στα ελληνικά η «αγκύρωση» είναι κυριολεκτική (πλοίο, μηχανική, οδοντιατρική), όχι εννοιολογική/νομική βάση. Πες «με βάση το Άρθρο Χ», «πατάει στον νόμο Χ», όχι «αγκυρωμένο/άγκυρα στον νόμο Χ». |
| σκληρός φραγμός | υποχρεωτικός αποκλεισμός | Calque του «hard stop». ΠΡΟΣΟΧΗ στη διάκριση: «κώλυμα/περιορισμός/αποκλεισμός» είναι δόκιμοι νομικοί όροι στο σωστό πλαίσιο, π.χ. «ανυπέρβλητο κώλυμα» (μη εύρεση στοιχείων στο Κεντρικό Μητρώο Πραγματικών Δικαιούχων για ποσοστά άνω του 25% ως κώλυμα ολοκλήρωσης του onboarding), «συστημικός περιορισμός» (αποτυχία ελέγχου ζωντανότητας/liveness test ή εντοπισμός κυρώσεων που διακόπτει αυτόματα τη ροή eKYC). Απαγορεύεται μόνο το calque «σκληρός φραγμός»· πες «υποχρεωτικός αποκλεισμός». |
| απόλυτο κώλυμα | ρητή απαγόρευση | Όταν εννοείς νομοθετικό αποκλεισμό, πες «ρητή απαγόρευση». Το «ανυπέρβλητο κώλυμα» παραμένει δόκιμο όπου ταιριάζει (βλ. προηγούμενη γραμμή). |
| συμφιλίωση (για λογιστικό/οικονομικό reconciliation) | συμφωνία | Στα λογιστικά και τα οικονομικά το reconciliation είναι «συμφωνία» (συμφωνία λογαριασμών, τραπεζική συμφωνία, συμφωνία υπολοίπων), όχι «συμφιλίωση». Η «συμφιλίωση» στα ελληνικά αφορά διαφορές ή πρόσωπα (οικογενειακή, εργατική συμφιλίωση), όχι αντιπαραβολή αριθμών ή λογαριασμών. |
| σταυρώνω / σταύρωσε (για cross-check) | διασταυρώνω / διασταύρωσε | Το cross-check είναι «διασταύρωση». Το «σταυρώνω» στα ελληνικά σημαίνει βάζω σταυρό ή σταυρώνω κάτι, όχι αντιπαραβάλλω στοιχεία από δύο πηγές. Πες «διασταύρωσε τα ποσά με τα πρωτότυπα», όχι «σταύρωσε τα ποσά». |
| καθαρό / καθαρά (όταν σημαίνει «clear», πλήρη κατανόηση του τι πρέπει να γίνει) | ξεκάθαρο / ξεκάθαρα | Όταν το «clear» δηλώνει ότι έχει γίνει πλήρως αντιληπτό τι πρέπει να γίνει (όχι καθαριότητα), η σωστή λέξη είναι «ξεκάθαρο/ξεκάθαρα». Πες «είναι ξεκάθαρο τι πρέπει να γίνει» ή «όρισέ το ξεκάθαρα». Απόφυγε τη σκέτη λέξη «καθαρό/καθαρά» με αυτή την έννοια, αφού το «καθαρός» στα ελληνικά δηλώνει καθαριότητα ή αθωότητα. Βλ. και τις γραμμές §16 για τη σαφήνεια λόγου. |
| ακόνισμα του σκεπτικού / ακονίζω το σκεπτικό | εξειδίκευση της αιτιολογίας | Calque του «sharpen the reasoning». Σε Αναφορές Καταλληλότητας, η «εξειδίκευση της αιτιολογίας» τεκμηριώνει με σαφήνεια γιατί ένα χρηματοπιστωτικό μέσο ή μια παράγωγη σύμβαση ταιριάζει στο προφίλ του πελάτη. |
...
| EN | EL (επίσημος όρος) |
|---|---|
| retail client | ιδιώτης πελάτης |
| professional client | επαγγελματίας πελάτης |
| eligible counterparty | επιλέξιμος αντισυμβαλλόμενος |
| suitability (assessment) | (αξιολόγηση) καταλληλότητας |
| appropriateness (assessment) | (αξιολόγηση) συμβατότητας |
| target market | αγορά-στόχος |
| product governance | διακυβέρνηση προϊόντων |
| manufacturer / distributor | κατασκευαστής / διανομέας |
| investment advice | επενδυτική συμβουλή |
| reception and transmission of orders | λήψη και διαβίβαση εντολών |
| execution only | εκτέλεση μόνο εντολών |
| complex / non-complex instrument | σύνθετο / μη σύνθετο χρηματοπιστωτικό μέσο |
| inducements | αντιπαροχές |
| best execution | βέλτιστη εκτέλεση |
...
| EN | EL |
|---|---|
| ICT (information and communication technology) | ΤΠΕ (τεχνολογίες πληροφοριών και επικοινωνιών) |
| (digital) operational resilience | (ψηφιακή) επιχειρησιακή ανθεκτικότητα |
| ICT third-party service provider | τρίτος πάροχος υπηρεσιών ΤΠΕ |
| critical or important function | κρίσιμη ή σημαντική λειτουργία |
| ICT risk | κίνδυνος ΤΠΕ |
| (major) ICT-related incident | (μείζον) συμβάν που σχετίζεται με ΤΠΕ |
...
| EN | EL |
|---|---|
| OTC derivative | εξωχρηματιστηριακό παράγωγο |
| central counterparty (CCP) | κεντρικός αντισυμβαλλόμενος |
| clearing obligation | υποχρέωση εκκαθάρισης |
| trade repository | αρχείο καταγραφής συναλλαγών |
| risk-mitigation techniques | τεχνικές μείωσης κινδύνου |
| margin | περιθώριο ασφάλισης |

**Αντικατάσταση αγγλόφωνων εκφράσεων σε SOPs/eKYC/AML (κατά πλαίσιο)**

| Έκφραση | Ελληνική απόδοση (ανάλογα με το πλαίσιο) |
|---|---|
| hard block | υποχρεωτικός περιορισμός (έλεγχος ορίων)· αυτόματη διακοπή λειτουργίας (τεχνικό σφάλμα) |
| hard stop | υποχρεωτικός αποκλεισμός |
| soft block / warning | προειδοποιητικός έλεγχος· προειδοποίηση |
| override | υπέρβαση ή παράκαμψη ελέγχου |
| screening (sanctions / PEP) | έλεγχος (κυρώσεων / PEP) |
| liveness test | έλεγχος ζωντανότητας |
| onboarding | ένταξη πελάτη |
| beneficial owner | πραγματικός δικαιούχος |

### 18. Τακτικά αριθμητικά σε αριθμημένη σειρά, όχι απόλυτα

Όταν ένας αριθμός δηλώνει τη θέση ενός στοιχείου μέσα σε μια σειρά και ακολουθεί (ή προηγείται) το ουσιαστικό, τα ελληνικά θέλουν **τακτικό** αριθμητικό, όχι **απόλυτο**. Η «Ροή 2» διαβάζεται «Ροή δύο» και είναι αγγλισμός. Το σωστό είναι «Ροή 2η», «2η ροή» ή «δεύτερη ροή». Το ίδιο δείχνει η ονοματολογία των ημερών: η Δευτέρα, η Τρίτη, η Τετάρτη και η Πέμπτη προέρχονται από τακτικά (δεύτερη, τρίτη, τέταρτη, πέμπτη). Κανείς δεν λέει «μέρα Δύο».

| Λάθος (απόλυτο) | Σωστό (τακτικό) |
|---|---|
| Ροή 2 | Ροή 2η / δεύτερη ροή |
| Κανόνας 3 | Κανόνας 3ος / τρίτος κανόνας |
| Φάση 1 | Φάση 1η / πρώτη φάση |
| Βήμα 2 | Βήμα 2ο / δεύτερο βήμα |
| Λόγος 1 | Πρώτος λόγος / Λόγος 1ος |

**Κανόνας:** Αριθμημένη ετικέτα στοιχείου σε σειρά (ροή, κανόνας, φάση, βήμα, λόγος, στάδιο, μέρος, γύρος) μπαίνει σε τακτικό αριθμητικό και όλη η σειρά κρατά την ίδια μορφή. Δεν αναμειγνύεται «Ροή 1η» με «Ροή 2».

**Εξαίρεση: παραμένουν απόλυτα.** Οι τυποποιημένες παραπομπές και οι κωδικοί ταυτότητας δεν είναι τακτικά και δεν αλλάζουν: «άρθρο 27», «παράγραφος 1», «περίπτωση κ΄», «ΦΕΚ Β΄ 235», «ν. 5144/2024», «σελίδα 12», αριθμοί απόφασης ή έκδοσης. Ομοίως η αρίθμηση ενοτήτων με αραβικό ψηφίο και τελεία στην αρχή τίτλου («1. Θέμα», «2. Συμπέρασμα») είναι δόκιμη σύμβαση κειμένου. Ο κανόνας χτυπά μόνο το μοτίβο «ουσιαστικό + απόλυτο αριθμητικό» ως ετικέτα σειράς.
