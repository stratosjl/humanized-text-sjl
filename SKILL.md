...
| σκληρός φραγμός / απόλυτο κώλυμα | δεν επιτρέπεται / αποκλείεται / ρητή απαγόρευση | Calque/ξύλινη απόδοση του «hard stop». Πες απλά «δεν επιτρέπεται» ή «αποκλείεται», όχι «σκληρός φραγμός» ούτε «απόλυτο κώλυμα». |
| ακόνισμα του σκεπτικού / ακονίζω το σκεπτικό | αποσαφήνιση / ενίσχυση / βελτίωση του σκεπτικού | Calque του «sharpen the reasoning». Το «ακονίζω» αφορά κυριολεκτικά κοπτικά εργαλεία· για επιχειρήματα πες «αποσαφηνίζω/ενισχύω/βελτιώνω το σκεπτικό». |
