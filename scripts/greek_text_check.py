...
GREEK_HARD_BLOCK = {
    ...
    "σκληρός φραγμός":        "υποχρεωτικός αποκλεισμός (Rule §16: calque του «hard stop»)",
    "σκληρό φραγμό":          "υποχρεωτικό αποκλεισμό (Rule §16: calque του «hard stop»)",
    "ακόνισμα του σκεπτικού": "εξειδίκευση της αιτιολογίας (Rule §16: calque του «sharpen the reasoning»)",
    "ακονίζω το σκεπτικό":    "εξειδικεύω την αιτιολογία (Rule §16)",
}
